...
# regular import gives error in Windows, direct import private method solves the problem
from pickle import _Unpickler
from outliers.outlier_cleaner import outlierCleaner

# load up some practice data with outliers in it
unpickAge = _Unpickler(open("practice_outliers_ages.pkl", mode="rb"),
                       fix_imports=True, encoding='ASCII', errors='strict')
ages = unpickAge.load()
unpickNW = _Unpickler(open("practice_outliers_net_worths.pkl", mode="rb"),
                      fix_imports=True, encoding='ASCII', errors='strict')
net_worths = unpickNW.load()
